    ...
    <Box>
        ...
        <Container mb={5}>
            ...
            <Text p={'2rem 0 2rem 0'}>
                <i>
                    Here&apos;s a component that pulls my Spotify listening
                    history:
                </i>
            </Text>
            <MusicHistory />
            <Text p={'2rem 0 2rem 0'}>
                <i>
                    and here&apos;s a component that displays my recent posts
                    from instagram with a blur in/out animation:
                </i>
            </Text>
        ...
        <Container>
            <Box height={40}>
                <SimpleGrid columns={4} spacing={5} h={10} p={10}>
                    <IconLink
                        url={'https://open.spotify.com/user/harveyives'}
                        icon={<FaSpotify color={'orange'} size={'50%'} />}
                    />
                    <IconLink
                        url={'https://m.me/harveyives'}
                        icon={
                            <FaFacebookMessenger
                                color={'orange'}
                                size={'50%'}
                    ...
                    />
                    <IconLink
                        url={'https://linkedin.com/in/harveyives'}
                        icon={<FaLinkedin color={'orange'} size={'48%'} />}
                    />
                    <IconLink
                        url={'https://github.com/harveyives'}
                        icon={<FaGithub color={'orange'} size={'50%'} />}
                    />
                </SimpleGrid>
            </Box>
        </Container>
